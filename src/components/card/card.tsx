...
export const Card: FC<CardProps> = ({ id, url, title, rating, text, duration, price, isLoading }) => {
  if (isLoading) {
    return (
      <Stack display={"inline-flex"} direction={"column"} gap={"15px"}>
        <Box sx={{ maxWidth: "302px", marginRight: 0.5, my: 5 }}>
          <Skeleton sx={{ borderRadius: "6px" }} variant="rectangular" width={302} height={290} />
          <Box sx={{ pt: "3px" }}>
